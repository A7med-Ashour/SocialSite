...
INSERT INTO friendRequest VALUES (2,4,'ACCEPTED',CURRENT_DATE());
INSERT INTO friendRequest VALUES (2,6,default,CURRENT_DATE());
INSERT INTO friendRequest VALUES (7,2,'ACCEPTED',CURRENT_DATE());
INSERT INTO friendRequest VALUES (5,2,default,CURRENT_DATE());
INSERT INTO friendRequest VALUES (5,6,default,CURRENT_DATE());
INSERT INTO friendRequest VALUES (7,2,'ACCEPTED',CURRENT_DATE());
INSERT INTO friendRequest VALUES (10,2,default,CURRENT_DATE());
...
SELECT user.ID , user.name ,  email ,CASE WHEN state IS NULL THEN 'NOT FRIEND' Else state END AS State FROM user
 ...
 ) As requests ON user.ID = requests.ID where user.ID != 2 AND (name LIKE "%a%" OR email LIKE "%a%") ;
